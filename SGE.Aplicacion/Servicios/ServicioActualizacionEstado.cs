...
{
    public void ModificarExpediente(int idExpediente) //cada vez que se cree, modifique o elimine el ultimo tramite se tiene que actualizar
    {
        ...
        if(etiqueta != null){
            ...
            if(estado != null){ //si no es null quiere decir que tengo que actualizar el estado del expediente
                repoExpediente.ActualizarEstado(idExpediente,estado, DateTime.Now); //enviar al repositorio de expedientes el id y el estado nuevo
             }
        }
